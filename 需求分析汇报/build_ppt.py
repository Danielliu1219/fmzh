...
txt(s, 7.55, 2.62, 4.9, 2.4, [
    ...
    {'runs': [('·  个性化生成 → 复习计划 / 自测题', 11, False, RGBColor(0xD9, 0xE4, 0xDE))], 'ls': 1.15},
])
# 底部方案带
...
txt(s, 0.9, 1.36, 11.6, 1.1, [
    ...
    {'runs': [('系统调用大模型生成个性化复习重点、按天计划与自测题，配套打卡与统计，一站式科学备考。', 12.5, False, WHITE)], 'ls': 1.2},
])
